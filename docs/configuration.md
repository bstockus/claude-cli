...
| `style`, `summary`, `external`, `cache`, `reportRedirects`, `check`, `write`, `anchors`, `images`, `ordered`, `content`, `brokenOnly`, `includeHeading`, `children`, `raw`, `includeOk`, `dryRun`, `backlinks`, `mermaid`, `katex`, `references`, `frontmatter`, `graph`, `toc` | Boolean.                                                                                                                                           |
...
| `include`, `exclude`, `ignore`, `ignoreDomain`, `entry`, `assetExtension`, `section`                                                                                                                                                                                            | List of strings.                                                                                                                                   |
