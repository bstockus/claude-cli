...
| ------------------- | ------- | -------------------------------------------------------------- |
| `--target <target>` | all     | Repeatable target: `claude-code`, `codex`, `cursor`, or `all`. |
...
Malformed manifests are skipped rather than reported: [`agent uninstall`](agent-uninstall.md)
