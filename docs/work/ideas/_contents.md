...
| [012](012-source-linked-snippet-checking.md)                  | Source-Linked Snippet Checking                  | P2       | Medium                   | Not started | Detect documentation examples that drift from code        |
| [013](013-agent-test.md)                                      | `agent test`                                    | P2       | Medium-large             | Not started | Catch behavioral-contract and artifact regressions        |
